...
<dialog ref="myself" class="add-item">
    ...
    <div style="margin-bottom: 10px">
        <label class="add-item-title matter-textfield-standard"><input type="text" ref="txt" size="50" :disabled="!selI" v-model="newTitle" @keyup.enter="addItem" placeholder=" "/><span>Title</span></label>
    </div>
